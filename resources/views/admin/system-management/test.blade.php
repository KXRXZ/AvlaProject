  ...
  <div class="flex items-center justify-center px-6">
    ...
    <div class="flex items-center justify-center ml-auto">
      <ul class="flex space-x-14 md:space-x-14 font-medium">
        ...
        <li class="group relative">
          <a href="#about" class="block py-6 px-3 text-xl text-orange-400 hover:text-[#024764] transform transition duration-300 group-hover:-translate-y-1">About</a>
          <div class="h-0.5 bg-[#024764] absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 group-hover:w-full transition-all duration-300"></div>
        </li>
        <li class="group relative">
          <a href="#trucks" class="block py-6 px-3 text-xl text-orange-400 hover:text-[#024764] transform transition duration-300 group-hover:-translate-y-1">Trucks</a>
          <div class="h-0.5 bg-[#024764] absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 group-hover:w-full transition-all duration-300"></div>
        </li>
        <li class="group relative">
          <a href="#faqs" class="block py-6 px-3 text-xl text-orange-400 hover:text-[#024764] transform transition duration-300 group-hover:-translate-y-1">FAQs</a>
          <div class="h-0.5 bg-[#024764] absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 group-hover:w-full transition-all duration-300"></div>
        </li>
        <li class="group relative">
          <a href="#contact" class="block py-6 px-3 text-xl text-orange-400 hover:text-[#024764] transform transition duration-300 group-hover:-translate-y-1">Contact</a>
          <div class="h-0.5 bg-[#024764] absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 group-hover:w-full transition-all duration-300"></div>
        </li>
          <!-- Theme Toggle -->
...
<div id="home" class="flex flex-col justify-center items-center h-screen bg-[#FFF6EF] px-8">
    <div id="home-content" class="opacity-0 translate-y-8 transition-all duration-1000 ease-out text-center">
      ...
      <div class="mt-8 flex items-center justify-center">
        <button class="bg-[#FFF6EF] border-2 border-[#FAE3D3] hover:bg-[#F08E80] font-bold py-3 px-6 text-sm transition-all duration-300 h-10 w-56 flex items-center justify-center rounded-lg ">
          Book Now
      </button>
...
<div id="trucks" class="h-screen bg-[#FFF6EF] flex flex-col justify-center items-center scroll-mt-10">
    <h1 class="text-[32px] font-semibold text-black">Truck Classifications</h1>
    ...
    <div class="flex justify-center space-x-4 py-6">
      <button class="bg-[#FFF6EF]  hover:text-white hover:bg-[#F08E80] border-2 border-[#FAE3D3] text-[#024764] py-2 px-6 rounded-lg">6 Wheeler Truck</button>
      <button class="bg-[#FFF6EF]  hover:text-white hover:bg-[#F08E80] border-2 border-[#FAE3D3] text-[#024764] py-2 px-6 rounded-lg">10 Wheeler Truck</button>
    </div>
    <!-- Truck Cards -->
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-8 py-6">
      ...
      <div class="w-[360px] h-[550px] max-w-sm p-8 bg-[#FDECE0] border-2 border-[#FAE3D3] shadow-md flex flex-col items-center">
        ...
        <button class="mt-16 w-full bg-[#FFF6EF] hover:text-white hover:bg-[#F08E80] border-2 border-[#FAE3D3] text-[#024764] py-3 text-base rounded-lg w-64">Rent Now</button>
      </div>
      <!-- Card 2 -->
      <div class="w-[360px] h-[550px] max-w-sm p-8 bg-[#FDECE0] border-2 border-[#FAE3D3] shadow-md flex flex-col items-center rounded-lg">
        <div class="bg-[#FFF6EF] h-48 w-full rounded-md"></div>
        <h2 class="text-xl text-[#024764] font-bold mt-6 text-center">TATA Ace HT mini</h2>
        <ul class="mt-3 text-[#024764] text-base space-y-2 text-center">
          <li>&#10004; Manual Transmission</li>
      ...
      <div class="w-[360px] h-[550px] max-w-sm p-8 bg-[#FDECE0] border-2 border-[#FAE3D3] shadow-md flex flex-col items-center">
        ...
        <button class="mt-16 w-full bg-[#FFF6EF] hover:text-black hover:bg-[#F08E80] border-2 border-[#FAE3D3] text-[#024764] py-3 text-base rounded-lg w-64">Rent Now</button>
      </div>
    </div>
</div>
  <!-- FAQs Section -->
<div id="faqs" class="section flex justify-center items-center h-screen bg-[#FFF6EF] pt-10 scroll-mt-10">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-20 items-center p-10 max-w-6xl w-full">
        ...
        <div class="flex flex-col items-center w-full text-center">
            <h1 class="text-[32px] font-semibold text-black">Frequently Asked Questions</h1>
            <p class="text-sm text-[#024764] text-center max-w-xl mt-2">
...
<div id="contact" class="text-center mb-6 w-full ">
    ...
    <form class="space-y-4">
        ...
        <button class="w-full bg-[#FFF6EF] text-[#024764] py-1 px-2 border-2 border-[#FAE3D3] font-semibold hover:text-white hover:bg-[#F08E80] w-24 mx-auto rounded-lg">
            Submit
        </button>
    </form>
</div>
 ...
 <div class="max-w-6xl mx-auto grid grid-cols-4 gap-6 text-sm text-white">
    ...
    <p class="text-[#024764]">1234 Street, City, State</p>
     ...
     <div>
         ...
         <input type="email" placeholder="Email Address" class="mt-2 p-2 w-64 bg-[#FFF6EF] rounded-md text-black focus:ring-FAE3D3">
